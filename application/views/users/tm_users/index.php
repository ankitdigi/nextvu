...
?>
						...
						<div class="col-xs-12">
							...
							<div class="box">
								<div class="box-header">
									...
									<p class="pull-right">
										<a href="<?php echo base_url('tm_users/add'); ?>" class="btn btn-primary ad-click-event"><?php echo $this->lang->line("add");?></a>
									</p>
								</div>
								<!-- /.box-header -->
								<div class="box-body">
		...
		$(document).ready(function(){
			...
			var dataTable = $('#tm_users').DataTable({
				...
				"fixedColumns": true,
				"ajax": {
					"url": "<?php echo base_url('users/tm_users_getTableData'); ?>",
					"type": "POST",
				},
				"columns": [
					{ "data": "name"},
					...
					{ "data": "id", render : function ( data, type, row, meta ) {
						return  '<div class="btn-group"><a class="btn btn-sm btn-outline-light" href="<?php echo base_url('tm_users/edit/'); ?>'+data+'" title="Edit"><i class="fa fa-pencil" style="font-size:initial;"></i></a>  <a class="btn btn-sm btn-outline-light delTM" href="javascript:void(0);" data-href="<?php echo base_url('users/tm_users_delete/'); ?>'+data+'" title="Delete"><i class="fa fa-trash" style="font-size:initial;"></i></a>  </div>';
					} }
					<?php }else{ ?>
					{ "data": "id", render : function ( data, type, row, meta ) {
						return  '<div class="btn-group"><a class="btn btn-sm btn-outline-light" href="<?php echo base_url('tm_users/edit/'); ?>'+data+'" title="Edit"><i class="fa fa-pencil" style="font-size:initial;"></i></a></div>';
					} }
					<?php } ?>
				]
			});
			...
			$(document).on('click','.delTM', function(){
				if(confirm('Are you sure you want to delete this TM User?')){
