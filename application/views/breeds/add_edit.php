					...
					<div class="row">
						...
						<div class="col-xs-12">
							...
							<div class="box box-primary">
								...
								<!-- form start -->
								<?php echo form_open('', array('name'=>'breedForm', 'id'=>'breedForm')); ?>
									<div class="box-body">
										<div class="row">
												...
												<div class="form-group">
													...
													if(!empty($species)){
														foreach ($species as $specie) {
															$specie_id = $specie['id'];
															$options[$specie_id] = $specie['name'];
														}
													}
													$attr = 'class="form-control" data-live-search="true" required=""';
													echo form_dropdown('species_id',$options,set_value('species_id',isset($data['species_id']) ? $data['species_id'] : ''),$attr); ?>
													<?php echo form_error('species_id', '<div class="error">', '</div>'); ?>
												</div>
												<div class="form-group">
													<label>Name</label>
