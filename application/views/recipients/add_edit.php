					...
					<div class="row">
						...
						<div class="col-xs-12">
							...
							<div class="box box-primary">
								...
								<!-- form start -->
								<?php echo form_open('', array('name'=>'recipientForm', 'id'=>'recipientForm')); ?>
									<div class="box-body">
										<div class="row">
											<div class="col-sm-6 col-md-6 col-lg-6">
												<div class="form-group">
													...
													echo form_multiselect('order_type[]', ORDER_TYPE_ARRAY, isset($data['order_type']) ? json_decode($data['order_type']) : '', $attr);
													?>
