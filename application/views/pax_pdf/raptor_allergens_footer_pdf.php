<table style="width:100%;">
	<tbody>
		<tr><td width="30%" align="left" style="font-size:11px;text-align:left;padding-left: 40px;">
			<img src="<?php echo base_url(); ?>assets/images/Extract.png" alt="Allergen Extract" style="width: 18px;vertical-align: middle;">&nbsp;&nbsp;&nbsp; <?php echo $this->lang->line('allergen_extract'); ?></td>
			<td width="60%" align="left" style="font-size:11px;text-align:left;">
			<img src="<?php echo base_url(); ?>assets/images/Molecular.png" alt="Molecular Allergen	" style="width: 18px;vertical-align: middle;">&nbsp;&nbsp;&nbsp; <?php echo $this->lang->line('molecular_allergen'); ?></td>
