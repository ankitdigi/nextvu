...
<html class="js">
	<head>
		...
		*{margin:0;padding:0;box-sizing:border-box;font-family:'Mark Pro'}
		...
		/*.diets tr th{font-weight:400;font-size:13px;padding:20px 5px 10px;width:20px;border-left:1px solid #9acfdb;border-bottom:3px solid #9acfdb;position:relative;height:80px;text-align:left}
		...
		.diets tr td:first-child{text-align:left;font-size:12px;}
		.diets tr th .rotate{transform:rotate(270deg);display:block;transform-origin:center bottom;text-align:left;position:absolute;white-space:nowrap;left:2px;bottom:20px;text-align:left}
		.diets tr td{border-left:1px solid #9acfdb;border-bottom:1px solid #9acfdb;font-size:13px;text-align:center;padding:0px}
		.diets tr td img{width: 18px;}*/
		</style>
	</head>
	<body bgcolor="#fff">
		<table class="header" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="width:100%; border-bottom:2px solid #366784;background:url(<?php echo base_url(); ?>assets/images/pax-bg.png) center top no-repeat #ffffff;background-size:100%;/*margin:40px;*/">
			...
			<tr>
				<td valign="bottom" width="400" style="padding-left: 40px;padding-right: 20px;padding-top: 60px;">
					<h5 style="font-weight:700; font-size:28px; color:#366784;"><?php echo $this->lang->line('PAX_Environmental'); ?></h5>
				</td>
			</tr>
		</table>
