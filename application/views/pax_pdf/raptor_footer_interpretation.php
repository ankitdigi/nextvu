<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" style="margin:40px;padding:0px;border:none;">
	<tr>
		<td width="100%" style="font-size: 11px; color: #000; text-transform: uppercase;">
			<?php echo $this->lang->line('interpretation_DISCLAIMER'); ?>
		</td>
	</tr>
</table>
<table style="width:100%;">
	<tbody>
		<tr><td width="30%" align="left" style="font-size:11px;text-align:left;padding-left: 40px;"></td>
			<td width="60%" align="left" style="font-size:11px;text-align:left;"></td>
