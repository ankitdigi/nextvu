			...
			<div class="content-wrapper">
				...
				<section class="content">
					...
					<div class="row">
						...
						<div class="col-xs-12">
						<!-- form start -->
						<?php echo form_open('', array('name'=>'referralsForm', 'id'=>'referralsForm')); ?>
						<!-- referrals form elements start-->
						<div class="box box-primary">
							...
							<div class="row">
								<div class="col-sm-6 col-md-6 col-lg-6">
									...
									<div class="checkbox">
										<label>
										<input type="checkbox" name="deliver_to_referral_practice" value="1" <?php echo ( isset($data['deliver_to_referral_practice']) && $data['deliver_to_referral_practice']) ? 'checked' : ''; ?>>
										Deliver to Referral Practice?
										</label>
									</div>
									<?php echo form_error('deliver_to_referral_practice', '<div class="error">', '</div>'); ?>
									</div>
									...
									<!-- <textarea class="form-control" name="address_1" rows="3" placeholder="Enter Address" required=""><?php //echo set_value('address_1',isset($data['address_1']) ? $data['address_1'] : '');?></textarea> -->
