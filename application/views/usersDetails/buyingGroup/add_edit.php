			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					...
					<ol class="breadcrumb">
						...
						<li class="active">Buying Group</li>
					</ol>
				</section>
				...
				<section class="content">
					...
					<div class="row">
						...
						<div class="col-xs-12">
							<!-- form start -->
							<?php echo form_open('', array('name'=>'buyingGroupForm', 'id'=>'buyingGroupForm')); ?>
								<!-- buying_groups form elements start-->
								<div class="box box-primary">
									...
									<!-- buying_groups form elements end-->
