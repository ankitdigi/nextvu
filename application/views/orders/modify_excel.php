			...
			<div class="col-xs-12">
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<p class="pull-left">
							<a href="<?php echo site_url('orders/interpretation/'.$orderId.''); ?>" class="btn btn-primary ad-click-event"><i class="fa fa-long-arrow-left back-btn-cls" style="font-size:initial;"></i><?php echo $this->lang->line("back");?></a>
						</p>
					</div>
										...
										<table style="width: 80%;" border="1">
											<?php foreach ($data as $key => $val) { ?>
												<tr>
													...
													<td style="width: 25%">
														<?php if($val['column1'] == 'REF. CUSTOMER' || $val['column1'] == 'IMMUNOTHERAPY RECOMMENDED'){ ?>
															<input style="width: 100%; background-color: #e3e0e0;" type="text" name="column2[<?= !empty($val['id']) ? $val['id'] : ''; ?>]" value="<?= !empty($val['column2']) ? $val['column2'] : ''; ?>">
														<?php }else{ ?>
													...
													<td style="width: 25%">
														<input style="width: 100%; background-color: #e3e0e0;" type="text" name="column4[<?= !empty($val['id']) ? $val['id'] : ''; ?>]" value="<?= !empty($val['column4']) ? $val['column4'] : ''; ?>">
													</td>
												</tr>
											<?php } ?>
										</table>
