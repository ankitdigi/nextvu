				...
				<tr>
					<td style="background:#e2f2f4; border-radius:0 0 12px 12px; padding:15px;">
						<table>
							...
							<tr>
								<td colspan="2" style="color:#1b3542; font-weight:400; font-size:14px; padding:12px 0 0 0;"><?php echo $this->lang->line('patient_anti_foods_tested'); ?></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<div class="roundedborder_div">
					<div>
						<div style="padding: 0px 0px 5px 0px;">
							...
							<p style="color:#1e3743; font-size:14px; margin:4px 0 0 0;"><?php echo $this->lang->line('food_positive_text'); ?></p>
						</div>
					</div>
					<div>
						<div style="padding: 0px 0px 5px 0px;">
							...
							<p style="color:#1e3743; font-size:14px; margin:4px 0 0 0;"><?php echo $this->lang->line('no_it_is_not_necessary_to_send_new_serum'); ?></p>
							<p style="color:#1e3743; font-size:14px; margin:4px 0 0 0;"><?php echo $this->lang->line('to_expand_the_screen_simply_complete_the_boxes_below_and_send_via_email_once_we_receive_your_request_we_will_report_the_expanded_results_to_you_within_few_days_via_email'); ?></p>
						</div>
					</div>
				</div>
			</div>
