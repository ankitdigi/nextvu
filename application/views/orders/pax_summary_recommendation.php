	...
	<tr>
		<td style="padding: 5px;">
			...
			<table width="100%">
				<tr>
					<td>
						<textarea class="form-control treatment_comment" name="treatment_comment" rows="15" style="background:#f2f5f8;border-radius:10px;" readonly><?php echo !empty($order_details['interpretation'])?$order_details['interpretation']:$dummytext; ?></textarea>
					</td>
				</tr>
			</table>
