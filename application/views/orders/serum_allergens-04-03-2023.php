								...
								<?php echo form_open('', array('name'=>'allergensForm', 'id'=>'allergensForm')); ?>
									<div class="box-header with-border">
										<div class="pull-left">
											...
											<input type="hidden" name="allergenArr" value='<?php echo $data['allergens']; ?>'>
										...
										<div class="pull-right">
											<?php if($slected_treatment == 2){ ?>
											<a onclick="return confirm('Are you sure you want to deleted Treatment Option 2? Once deleted, the treatment option can not be re-instated.')" href="<?php echo site_url('orders/remove_treatment_2/'.$id.''); ?>" class="btn btn-primary">Remove Treatment 2</a><br><br>
											<?php } ?>
