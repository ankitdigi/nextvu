								...
								<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
									...
									<tr>
										<td align="center" style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height:20px; padding-top: 10px;">
											...
											<?php echo $this->lang->line('pax_result_attached1'); ?> <?php echo $order_details['pet_name']; ?> <?php echo $petownerName; ?> <?php echo $this->lang->line('pax_result_attached2'); ?>
											</p>
										</td>
									</tr>
									<?php if($this->session->userdata('site_lang') == 'danish'){ ?>
									<tr>
										<td align="center" style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height:20px; padding-top: 10px;">
											<p style="font-size: 18px; font-weight: 400; line-height: 20px; color: #777777;">Kontakt os venligst på kontor@vet-allergy.com, hvis du har brug for hjælp eller yderligere information.</p>
										</td>
									</tr>
									<?php } ?>
									<tr>
