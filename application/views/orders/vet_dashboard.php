							...
							<div class="col-xs-5" style="min-height:980px;">
								<div class="box box-primary">
									...
									<div class="box-body">
										...
										<?php if(!empty($block1) && ($ordeType == 'PAX Environmental' || $ordeType == 'PAX Environmental + Food' || $ordeType == 'PAX Environmental Screening Expanded' || $ordeType == 'PAX Environmental + Food Screening Expanded')){ ?>
											<div class="form-group">
