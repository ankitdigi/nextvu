	...
	<tr>
		<td style="padding: 5px;">
			...
			<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" style="">
				<tr>
					<td>
						<p style="color:#1e3743; font-size:13px; margin:4px 0 0 0;"><?php echo $this->lang->line('negative_result_text5'); ?></p>
					</td>
				</tr>
			</table>
			<table width="100%"><tr><td height="20"></td></tr></table>
			<table class="" cellspacing="0" cellpadding="0" border="0" align="left" width="75%" style="width:75%; border:1px solid #89ccd6; border-radius:0 12px 12px 12px; padding:15px;">
				<tr>
					<td>
						...
						<p style="color:#1e3743; font-size:13px; margin:4px 0 0 0;"><?php echo $this->lang->line('negative_result_text1'); ?></p>
					</td>
				</tr>
				<tr><td></td></tr>
				<tr>
					<td>
						<h6 style="color:#1e3743; font-size:18px; margin:0;"><?php echo $this->lang->line('negative_result_title2'); ?></h6>
						<p style="color:#1e3743; font-size:13px; margin:4px 0 0 0;"><?php echo $this->lang->line('negative_result_text2'); ?></p>
					</td>
				</tr>
			</table>
			<table width="100%"><tr><td height="20"></td></tr></table>
			...
			<table class="" cellspacing="0" cellpadding="0" border="0" align="left" width="47%">
				<tr>
					...
					<td><h6 style="color:#333333; font-size:16px; margin:0;"><?php echo $this->lang->line('negative_result_title3'); ?></h6></td>
				</tr>
				<tr>
			...
			<table class="" cellspacing="0" cellpadding="0" border="0" align="right" width="47%">
				<tr>
					<td width="35" style="line-height:0;"><img src="<?php echo base_url(); ?>assets/images/question.png" alt="" /></td>
					<td><h6 style="color:#333333; font-size:16px; margin:0;"><?php echo $this->lang->line('negative_result_title4'); ?></h6></td>	
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2"><p style="color:#333333; font-size:14px; line-height:21px; margin:10px 0 0 0;"><?php echo $this->lang->line('negative_result_title5'); ?></p></td>
				</tr>
			</table>
