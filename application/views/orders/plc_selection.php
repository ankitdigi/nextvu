...
?>
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					<h1>
					<?php echo $this->lang->line('practice_lab'); ?>
					...
					<div class="row">
						...
						<div class="col-xs-12">
							...
							<div class="box box-primary">
								...
								<!-- form start -->
								<?php echo form_open('', array('name'=>'plcForm', 'id'=>'plcForm')); ?>
									<!--Practice/Lab/Corporate-->
									<div class="box-body">
										<div class="row">
											<div class="col-sm-12 col-md-12 col-lg-12">
												<div class="middle">
													<label>
														<input type="radio" name="plc_selection" value="1" <?php if($id==""){echo 'checked=""';}elseif(isset($data['plc_selection']) && $data['plc_selection']=='1'){echo 'checked=""';} ?>/>
														<div class="front-end box">
															<span><?php echo $this->lang->line('practice'); ?></span>
														</div>
													</label>

													<label>
														<input type="radio" name="plc_selection" value="2" <?php echo (isset($data['plc_selection']) && $data['plc_selection']=='2') ? 'checked=""' : "" ;?>/>
														<div class="front-end box">
													...
													<!-- <label>
														<input type="radio" name="plc_selection" value="3" <?php //echo (isset($data['plc_selection']) && $data['plc_selection']=='3') ? 'checked=""' : "" ;?>/>
														<div class="front-end box">
														<span>Corporate</span>
														</div>
													</label> -->
