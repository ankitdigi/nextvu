...
if($ordeType == 'PAX Environmental' || $ordeType == 'PAX Environmental Screening' || $ordeType == 'PAX Environmental + Food' || $ordeType == 'PAX Environmental + Food Screening'){
	...
	$allengesArr = []; $allenges3Arr = []; $allenges4Arr = []; $block1 = []; $allengesIDsArr = array(); $dummytext = "";
					...
					<div class="row">
									...
									<div class="box-body">
										...
										<div class="form-group">
											...
											<?php if($ordeType == 'PAX Environmental' || $ordeType == 'PAX Environmental + Food'){ ?>
												<?php if(!empty($block1) && $order_details['is_serum_result_sent'] != 1){ ?>
												...
												<?php } ?>
												<?php if(!empty($block2) && ($block1 != $block2) && $order_details['is_serum_result_sent'] != 1 && $order_details['remove_treatment_2'] == 0){ ?>
										...
										<div class="form-group">
											<button id="sendResult" type="button" class="btn btn-primary top">Save, Send out & Close</button>
										</div>
						...
						<div class="col-xs-7 scroll" style="height:1325px;overflow:scroll;padding:0px;">
												...
												<tr>
													...
													<td valign="middle">
														<table cellspacing="0" cellpadding="0" border="0" width="100%" style="font-size:13px; line-height:20px;">
															...
															<tr>
																<th style="color:#346a7e;"><?php echo $this->lang->line('Address'); ?>:</th>
							...
							<?php }elseif($ordeType == 'PAX Food'){ ?>
								...
								<?php if($this->session->userdata('site_lang') != 'spanish' && $this->session->userdata('site_lang') != 'italian'){ require_once(APPPATH."views/orders/pax_diet_chart.php"); } ?>
								<?php } ?>
