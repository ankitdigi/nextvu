...
<html class="js">
	...
	<body bgcolor="#fff">
		...
		$block1 = []; $allengesIDsArr = array(); $dummytext = "";
																		...
																		<tr>
																			...
																			<?php
																				if(!empty($fleaResults)){
																					if($fleaResults->result_value >= 30){
				...
				<tr>
					<td width="100%">
						<table cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="margin: 0px auto 0 0;">
							<tr>
								<td width="100%">
									<table width="100%" cellspacing="0" cellpadding="0" border="0" style="padding: 0px 0; margin: 15px 0px 0 0;  background-image: url(<?php echo base_url(); ?>assets/images/question-bg-img-alt.png); background-repeat: no-repeat; background-position: left top; background-size: 100%;">
										<tbody>
											<?php
												if(!empty($fleaResults)){
													if($fleaResults->result_value >= 30){
														echo'<tr>
															<td style="padding: 55px 20px 10px 45px;">
																<table width="100%" cellspacing="0" cellpadding="0" border="0">
																	<tbody>
																		<tr>
										...
										<table width="100%" cellspacing="0" cellpadding="0" border="0">
											<tbody>
												...
												<tr>
													...
													<td colspan="2" style="color:#1e3743; font-size:11px; line-height: 16px;">
													<?php echo $this->lang->line('currently_immu_avail'); ?>
													</td>
													<?php }else{ ?>
													<td colspan="2" style="color:#1e3743; font-size:11px; line-height: 16px;">
					...
					<tr>
						<td width="100%">
							<table cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="margin: 0px auto;">
								<tr>
									<td width="100%">
										<table width="100%" cellspacing="0" cellpadding="0" border="0" style="padding: 0mm 0.5mm 2mm; margin: 10px 0px 0;  background-image: url(<?php echo base_url(); ?>assets/images/question-bg-img-new.png); background-repeat: no-repeat; background-position: left top; background-size: 100%;">
											<tbody>
												<tr>
													<td width="100%" style="padding: 50px 15px 5px 40px;">
														<table width="100%">
															<tbody>
																<tr>
																	<td style="color:#1e3743; font-size:12px;">
												...
												<tr>
													<td style="padding: 0px 15px 30px 40px;">
														<table width="100%">
															<tbody>
																<tr>
																	<td style="color:#1e3743; font-size:12px;">
													...
													<tr>
														<td width="50%">
															<table width="100%" cellspacing="0" cellpadding="0" border="0" style="background-image: url(<?php echo base_url(); ?>assets/images/reliable-bg-img.png); background-repeat: no-repeat; background-position: left top; background-size: 100%;">
																<tbody>
																	<tr>
																		<td width="65%" style="padding: 50px 5px 15px 50px;">
																			<table width="100%" cellspacing="0" cellpadding="0" border="0">
																				<tbody>
																					<tr>
																						<td width="100%" style="color:#1e3743; font-size:13px;">
																					...
																					<tr>
																						<td width="100%" style="color:#1e3743; font-size:11px; line-height: 18px;">
