									...
									<div class="box-body">
										<div class="row">
												...
												<?php if ($this->session->userdata('plc_selection') == '1' || $this->session->userdata('plc_selection') == '2') { ?>
													<?php if ($userData['role'] == 2 || $userData['role'] == 5) { ?>
														<?php if(count($vatLabUsers) == 1){ ?>
															<div class="form-group" <?php /* if($order_type == '2' && $this->session->userdata('plc_selection') == '2'){ echo 'style="display:none;"'; } */ ?>>
																<?php
																$accountRef = $this->UsersModel->getPracticeAccountRef($vatLabUsers[0]['id']);
																$account_ref = ($accountRef->column_field) ? ' - ' . $accountRef->column_field : '';
																?>
																...
																<select name="vet_user_id" class="form-control vet_user_id">
																	<option value="<?=$vatLabUsers[0]['id'];?>" selected="selected"><?=$vatLabUsers[0]['name'].$vatLabUsers[0]['postcode'].$account_ref;?></option>
																</select>
															</div>
														<?php }else{ ?>
														<div class="form-group" <?php /* if($order_type == '2' && $this->session->userdata('plc_selection') == '2'){ echo 'style="display:none;"'; } */ ?>>
															...
															if (!empty($vatLabUsers)) {
																foreach ($vatLabUsers as $user) {
																	...
																	$accountRef = $this->UsersModel->getPracticeAccountRef($user['id']);
																	$account_ref = ($accountRef->column_field) ? ' - ' . $accountRef->column_field : '';
													...
													<?php if ($userData['role'] != '2' && $userData['role'] != '5'){ ?>
													<!--don't show if branch is not there for reoeat order-->
													<?php if ($controller == 'orders' || ($controller == 'repeatOrder' && isset($id) && $id > 0 && isset($data['branch_id']) && $data['branch_id'] > 0) ) {  ?>
														<div class="form-group" style="display:none;">
															...
															$branches_attr = 'class="form-control order_branch_id" data-live-search="true"';
													...
													<?php } //don't show if branch is not there for reoeat order ?>
													<?php } ?>
													<div class="form-group">   
													...
													<div class="form-group">
														...
														<input type="text" class="form-control" name="email" placeholder="Enter <?=$emailabel?>" value="<?php echo set_value('email', $emailadr); ?>" <?php echo ($controller != 'repeatOrder') ? 'required=""' : ''; ?>>
													...
													<div class="form-group">
														...
														<input type="text" class="form-control" name="phone_number" placeholder="<?php echo $this->lang->line("enter_phone_number");?>" value="<?php echo set_value('phone_number', isset($data['phone_number']) ? $data['phone_number'] : ''); ?>" <?php //echo ( $controller!='repeatOrder' ) ? 'required=""' : ''; ?>>
												...
												<?php /* if ($sub_order_type == '3') { ?>
													<div class="form-group">
														...
														<div class="input-group date">
															...
															<input type="text" class="form-control pull-right" name="sampling_date" placeholder="Enter Order Date" value="<?php echo set_value('sampling_date', isset($data['sampling_date']) ? date("d/m/Y", strtotime($data['sampling_date'])) : ''); ?>" autocomplete="off">
														</div>
														<?php echo form_error('sampling_date', '<div class="error">', '</div>'); ?>
													</div>
												<?php } */ ?>
												<!--active in uk-->
											</div><!-- /.col -->
											...
											<div class="col-sm-6 col-md-6 col-lg-6">
												<?php /* if ($order_type == '2'){ ?>
												<div class="form-group">   
													<label>Submitted Veterinarian</label>
													<input type="text" class="form-control" name="veterinary_surgeon" placeholder="Enter Submitted Veterinarian" value="<?php echo set_value('veterinary_surgeon', isset($data['veterinary_surgeon']) ? $data['veterinary_surgeon'] : ''); ?>" required="">
													<span class="special_note">Note: Name of the Veterinary Surgeon.</span>
													<?php echo form_error('veterinary_surgeon', '<div class="error">', '</div>'); ?>
												</div>
												<?php } */ ?>
												<?php if ($order_type == '2'){ ?>
												<div class="form-group">   
												...
												<?php /* if ($order_type == '2') {  ?>
													<div class="form-group">
														<div class="checkbox">
															<label>
																<input type="checkbox" name="shipping_materials" value="1" <?php echo (isset($data['shipping_materials']) && $data['shipping_materials'] == 1) ? 'checked' : ''; ?> class="select_shipping_materials">
																I would like to order more shipping materials
															</label>
														</div>
														<?php echo form_error('shipping_materials', '<div class="error">', '</div>'); ?>
													</div>
													<div class="form-group qty" <?php echo (isset($data['shipping_materials']) && $data['shipping_materials'] == 1) ? '' : 'style="display:none"'; ?>>
														<label>Quantity</label>
														<input type="text" class="form-control" name="qty_order" placeholder="Enter Quantity" value="<?php echo set_value('qty_order', isset($data['qty_order']) ? $data['qty_order'] : ''); ?>">
														<?php echo form_error('qty_order', '<div class="error">', '</div>'); ?>
													</div>
													<div class="form-group">
														<div class="checkbox">
															<label>
																<input type="checkbox" name="samples_storage" value="1" <?php echo (isset($data['samples_storage']) && $data['samples_storage'] == 1) ? 'checked' : ''; ?> class="samples_storage">
														...
														<?php echo form_error('samples_storage', '<div class="error">', '</div>'); ?>
													</div>
												<?php } */ ?>
												<!-- shipping materials -->
												...
												<div class="form-group" <?php if($order_type == '2'){ echo 'style="display:none"'; } ?>>
													...
													<div class="radio">
														...
														<?php /* if($order_type == '1'){ ?>
														<label><input type="radio" name="order_can_send_to" id="order_can_send_to3" value="2" <?php echo (isset($data['order_can_send_to']) && $data['order_can_send_to'] == '2') ? 'checked=""' : ""; ?>>Enter other Delivery Address</label>
														<?php } */ ?>
													</div>
												...
												<div class="form-group other_add_field other_practices <?php echo $hidden_cls; ?> <?php echo $other_practices; ?>" <?php if($order_type == '2' || $this->session->userdata('order_type') == '2'){ echo 'style="display:none"'; } ?>>
													...
													if (!empty($deliveryPractices)) {
														foreach ($deliveryPractices as $deliveryPractice) {
															...
															$accountRef = $this->UsersModel->getPracticeAccountRef($deliveryPractice['id']);
															$account_ref = ($accountRef->column_field) ? ' - ' . $accountRef->column_field : '';
												...
												<div class="form-group other_add_field other_branches <?php echo $hidden_cls; ?>" style="display:none">
													...
													$branches_options = array();
													$branches_options[''] = '-- Select --';
													if (!empty($practice_branches)) {
														foreach ($practice_branches as $practice_branch) {
															$practice_branch_id = $practice_branch['id'];
															$branch_post_code = ($practice_branch['postcode'] != '') ? ' - ' . $practice_branch['postcode'] : '';
															$branches_options[$practice_branch_id] = $practice_branch['name'] . $branch_post_code;
														}
													}
													$branches_attr = 'class="form-control delivery_practice_branch_id" data-live-search="true"';
													echo form_dropdown('delivery_practice_branch_id', $branches_options, set_value('delivery_practice_branch_id', isset($data['delivery_practice_branch_id']) ? $data['delivery_practice_branch_id'] : ''), $branches_attr); ?>
													<?php echo form_error('delivery_practice_branch_id', '<div class="error">', '</div>'); ?>
												</div>
												<!--practice and branches-->
												<!-- address1,2,3.. -->
												<div class="form-group other_add_field <?php //echo $hidden_cls; ?>" <?php if($order_type == '2' || $this->session->userdata('order_type') == '2'){ echo 'style="display:none"'; } ?>>
