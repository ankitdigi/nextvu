										...
										<div class="row">
											...
											<div class="col-sm-6 col-md-6 col-lg-6">
												...
												<div class="form-group aName" id="danishName" style="display:none">
													<label>Allergen Danish Name</label>
													<input type="text" class="form-control" name="name_danish" placeholder="Enter Allergen Danish Name" value="<?php echo set_value('name_danish',isset($data['name_danish']) ? $data['name_danish'] : '');?>">
													<?php echo form_error('name_danish', '<div class="error">', '</div>'); ?>
												</div>
												<div class="form-group aName" id="frenchName" style="display:none">
													<label>Allergen French Name</label>
													<input type="text" class="form-control" name="name_french" placeholder="Enter Allergen French Name" value="<?php echo set_value('name_french',isset($data['name_french']) ? $data['name_french'] : '');?>">
													<?php echo form_error('name_french', '<div class="error">', '</div>'); ?>
												</div>
												<div class="form-group aName" id="germanName" style="display:none">
													<label>Allergen German Name</label>
													<input type="text" class="form-control" name="name_german" placeholder="Enter Allergen German Name" value="<?php echo set_value('name_german',isset($data['name_german']) ? $data['name_german'] : '');?>">
													<?php echo form_error('name_german', '<div class="error">', '</div>'); ?>
												</div>
												<div class="form-group aName" id="italianName" style="display:none">
													<label>Allergen Italian Name</label>
													<input type="text" class="form-control" name="name_italian" placeholder="Enter Allergen Italian Name" value="<?php echo set_value('name_italian',isset($data['name_italian']) ? $data['name_italian'] : '');?>">
													<?php echo form_error('name_italian', '<div class="error">', '</div>'); ?>
												</div>
												<div class="form-group aName" id="dutchName" style="display:none">
													<label>Allergen Dutch Name</label>
													<input type="text" class="form-control" name="name_dutch" placeholder="Enter Allergen Dutch Name" value="<?php echo set_value('name_dutch',isset($data['name_dutch']) ? $data['name_dutch'] : '');?>">
													<?php echo form_error('name_dutch', '<div class="error">', '</div>'); ?>
												</div>
												<div class="form-group aName" id="norwegianName" style="display:none">
													<label>Allergen Norwegian Name</label>
													<input type="text" class="form-control" name="name_norwegian" placeholder="Enter Allergen Norwegian Name" value="<?php echo set_value('name_norwegian',isset($data['name_norwegian']) ? $data['name_norwegian'] : '');?>">
													<?php echo form_error('name_norwegian', '<div class="error">', '</div>'); ?>
												</div>
												<div class="form-group aName" id="spanishName" style="display:none">
													<label>Allergen Spanish Name</label>
													<input type="text" class="form-control" name="name_spanish" placeholder="Enter Allergen Spanish Name" value="<?php echo set_value('name_spanish',isset($data['name_spanish']) ? $data['name_spanish'] : '');?>">
													<?php echo form_error('name_spanish', '<div class="error">', '</div>'); ?>
												</div>
												<div class="form-group aName" id="swedishName" style="display:none">
													<label>Allergen Swedish Name</label>
													<input type="text" class="form-control" name="name_swedish" placeholder="Enter Allergen Swedish Name" value="<?php echo set_value('name_swedish',isset($data['name_swedish']) ? $data['name_swedish'] : '');?>">
			...
			$(document).on('change','select[id="language_id"]',function(){
				...
				if(languageName != ''){
					if(languageName != 'english'){
						...
						$('select[name="order_type[]"]').removeAttribute('style');
						$('button[class="btn dropdown-toggle btn-default"]').removeAttribute('style');
						$('#parent_id').removeAttribute('style');
						$('#pax_parent_id').removeAttribute('style');
						$('div[class="checkbox"]').removeAttribute('style');
						$('select[name="mixture_order_type[]"]').removeAttribute('style');
						$('button[class="btn dropdown-toggle btn-default bs-placeholder"]').removeAttribute('style');
						$('input[name="pax_latin_name"]').removeAttribute('readonly');
						$('input[id="exactCode"]').removeAttribute('readonly');
						$('input[id="can_allgy_env"]').removeAttribute('readonly');
						$('input[id="fel_allgy_env"]').removeAttribute('readonly');
						$('input[id="equ_allgy_env"]').removeAttribute('readonly');
						$('input[id="can_allgy_food_ige"]').removeAttribute('readonly');
						$('input[id="can_allgy_food_igg"]').removeAttribute('readonly');
						$('input[id="fel_allgy_food_ige"]').removeAttribute('readonly');
						$('input[id="fel_allgy_food_igg"]').removeAttribute('readonly');
						$('input[id="equ_allgy_food_ige"]').removeAttribute('readonly');
						$('input[id="equ_allgy_food_igg"]').removeAttribute('readonly');
						$('select[id="allergens_id"]').removeAttribute('style');
						$('#addAllergens').removeAttribute('style');
					}
					$(".aName").hide();
